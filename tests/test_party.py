...
class PartyTestCase(BaseTestCase):
    ...
    def test_create_party(self):
        """ Test endpoint can create party """
    ...
    def test_get_all_parties(self):
        """ Test endpoint can retrieve all parties """
    ...
    def test_get_specific_party(self):
        """ Test endpoint can retrieve a specific political party """
        create_party(self, party)
    ...
    def test_edit_party(self):
        """ Test endpoint can update details of a specific party """
